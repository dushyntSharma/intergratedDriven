...
public class ShopApp {
	...
	public static void main(String[] args) {
		...
		ShopManagementSreviceImple shopManagementSreviceImple = new ShopManagementSreviceImple();
		int x = 0, y = 0;
		int choice;
		do {
			displayMenu();
	...
	public static void enterItems(List<Item> item, int x) {
		...
		sc.nextLine();
		item.add(new Item(x + 1, name, price, count));
	}
	...
	public static void enterBill(ShopManagementSreviceImple shopManagementSreviceImple, List<Shop> shop,
			List<Item> item) {
		System.out.println("Enter no of items");
		int n = sc.nextInt();
		sc.nextLine();
		...
		} while (!billItem.getCheckFlag() || n > 0);
